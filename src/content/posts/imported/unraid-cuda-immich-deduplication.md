...
---
[上一篇文章](/2025/07/11/unraid-immich-cuda-setup/ "上一篇文章")介绍了如何在UNRAID下编排部署带GPU加速的Immich容器，这次介绍如何用[immich-mediakit](https://github.com/RazgrizHsu/immich-mediakit)这个项目来实现带GPU加速的相似照片去重
